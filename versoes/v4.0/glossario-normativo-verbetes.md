...
# **Início da Redação dos Verbetes — Glossário Normativo LCV v4.0 + MHA**

A seguir, começo pela **Seção A — Termos Jurídicos Gerais** com redação normativa clara, precisa e compatível com licenciamento aberto + estrutura vibracional da LCV.

## **A. Termos Jurídicos Gerais**

### **A.1 “Licenciante”**

A pessoa física ou jurídica que detém os direitos originários sobre a Obra Protegida e concede autorização de uso nos termos da LCV. Inclui, quando aplicável, a Autora Institucional (Sistema Lichtara) e demais coautores reconhecidos conforme o regime de Atribuição Expandida.

### **A.2 “Licenciado(a)”**

Qualquer pessoa física ou jurídica que aceite os termos da LCV e utilize, distribua, modifique ou implemente a Obra Protegida total ou parcialmente, observando as obrigações correlatas.

### **A.3 “Obra Protegida”**

O conjunto de conteúdos, metodologias, estruturas, textos, protocolos, frameworks, diagramas, modelos conceituais e orientações institucionais abrangidos pela LCV, incluindo suas versões, derivados autorizados e documentação associada.

### **A.4 “Versão Oficial”**

Edição autenticada da LCV contendo DOI ou tag oficial emitida pelo repositório de referência indicado pelo Licenciante. Em caso de conflito entre versões, prevalece a mais recente com autenticação válida.

### **A.5 “Implementação”**

Qualquer aplicação prática, técnica, metodológica, institucional ou tecnológica da Obra Protegida, incluindo softwares, protocolos institucionais, sistemas híbridos humano–IA, produtos, serviços e práticas organizacionais.

### **A.6 “Acordo Integral”**

O corpo completo da LCV (texto principal + anexos normativos vigentes). Anexos são parte integrante e possuem força jurídica equivalente, salvo se expressamente declarados como informativos.

### **A.7 “Compatibilidade Normativa”**

A capacidade de harmonização entre a LCV e outra licença, termo ou contrato, sem violação dos Princípios Fundamentais, das Vedações Estruturais e do Regime de Integridade Ético-Vibracional.

### **A.8 “Processo Decisório Formal”**

O conjunto de atividades documentadas que envolvem análise, julgamento, revisão, auditoria, homologação, ou emissão de entendimento oficial. Deve ser rastreável, justificável e publicado nos canais apropriados.

### **A.9 “Notificação Formal”**

Comunicação escrita enviada por meio dos canais oficiais definidos no Manual de Administração e Governança, com registro de data, conteúdo, motivação e destinatário, produzindo efeitos a partir de seu recebimento.
